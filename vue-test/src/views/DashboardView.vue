...
<template>
  <div class="bg-gray-50 min-h-screen pb-20">
    ...
    >
      <div
        class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex justify-between items-center"
      >
        <div>
          <h1
      ...
      <div
        class="absolute right-[-2%] top-[-50%] opacity-10 text-[10rem] font-black text-white select-none pointer-events-none uppercase"
      >
        MFU
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col md:flex-row gap-8">
        <div class="w-full md:w-1/3 lg:w-1/4">
          ...
          >
            ...
            <div class="text-center mb-8">
              ...
              <span
                class="inline-block mt-3 px-3 py-1 bg-green-100 text-green-700 text-xs font-bold rounded-full"
              >
            ...
            <nav class="space-y-2">
              <button
                ...
                :class="
                  activeTab === 'bookings'
                    ? 'bg-red-50 text-[#ba0b2f] border-[#ba0b2f]'
        ...
        <div class="w-full md:w-2/3 lg:w-3/4">
          <div v-if="activeTab === 'bookings'" class="space-y-6">
            ...
            >
              ...
              <div class="p-6 md:flex justify-between items-center">
                <div class="flex gap-5 items-center">
                  <div
                    class="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center text-[#ba0b2f] text-2xl shadow-inner"
                  >
                  ...
                  <div>
                    ...
                    <div
                      class="flex flex-wrap items-center gap-4 mt-2 text-sm text-gray-500"
                    >
            ...
            >
              ...
              <p class="text-gray-400 mt-2">
                คุณยังไม่ได้ทำรายการจองพื้นที่ใดๆ
              </p>
              <RouterLink
                to="/rooms"
                class="inline-block mt-6 bg-[#ba0b2f] text-white px-6 py-2 rounded-lg font-bold hover:bg-[#8c0823] transition-colors"
              >
                เริ่มค้นหาพื้นที่
              </RouterLink>
            </div>
          ...
          >
            <h2
              class="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2 border-b border-gray-100 pb-4"
            >
            ...
            >
              <div
                class="space-y-2 md:col-span-2 bg-gray-50 p-4 rounded-xl border border-gray-100 mb-2"
              >
                <h4 class="text-sm font-bold text-gray-900 mb-3">
                  <i class="fas fa-id-card text-gray-400 mr-1"></i> ข้อมูลบัญชี
                  (อ้างอิงจากระบบ)
                </h4>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label class="block text-xs font-bold text-gray-500 mb-1"
                      >อีเมลมหาวิทยาลัย</label
                    >
                    <input
                      type="email"
                      v-model="userProfile.email"
                      disabled
                      class="w-full px-4 py-2.5 bg-gray-100/50 border border-gray-200 rounded-lg text-gray-500 cursor-not-allowed font-medium text-sm"
                    />
                  </div>
                  <div>
                    <label class="block text-xs font-bold text-gray-500 mb-1"
